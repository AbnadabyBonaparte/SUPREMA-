  ...
  const renderPage = () => {
    switch (currentPage) {
      ...
      case 'shop':
        return <ShopPage />;
      case 'login':
        return <LoginPage onLoginSuccess={() => setCurrentPage('home')} onUserNameClick={() => setCurrentPage('profile')} />;
      case 'membership':
...
export default App; // ← ESSA LINHA É OBRIGATÓRIA E ESTAVA FALTANDO
